...
\end{equation}
The fast carrier at $\frac{\sqrt{3}+1}{2}\omega_0$ is modulated by the slow envelope at $\frac{\sqrt{3}-1}{2}\omega_0$, and energy sloshes back and forth between the two masses (Figure~\ref{fig:coupled-beats}).
\end{example}
